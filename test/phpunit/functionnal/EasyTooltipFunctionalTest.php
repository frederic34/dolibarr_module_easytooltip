...
/**
 * \file    test/phpunit/EasyTooltipFunctionalTest.php
 * \ingroup easytooltip
...
/**
 * Class EasyTooltipFunctionalTest
 *
 ...
 *
 * @package Testeasytooltip
 */
class EasyTooltipFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 135650; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEasyTooltip')->click();
		} else {
			// Disable the module
			$this->byHref('modEasyTooltip')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/easytooltip/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('easytooltip/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/easytooltip/admin/about.php');
		$this->authenticate();
		return $this->assertContains('easytooltip/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('easytooltipwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEasyTooltip_EasyTooltipTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEasyTooltip_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
